...
export const NFTMintForm: React.FC<NFTMintForm> = ({
  ...
  return (
    <>
      <DrawerHeader>
        <Heading>Create Unlockable Content</Heading>
      </DrawerHeader>
      <DrawerBody>
        <Stack
          spacing={6}
        ...
        >
          <Stack>
            <Heading size="subtitle.md">Upload Files</Heading>
            <Divider />
          </Stack>
          ...
          <Heading size="subtitle.md">Select Token to Target</Heading>
            <Divider />
            <FormHelperText>
            If no tokens or properties are targeted, then all NFTs of this contract will be upgraded with this content. 
              </FormHelperText>
          ...
          <Input 
          autoFocus {...register("supply")} 
          placeholder='1-100, 150-200, 300, 302, 305...'
          />
            <FormErrorMessage>
              <>{errors?.supply?.message}</>
            </FormErrorMessage>
            <FormHelperText>
              You can add a single token id, a comma separated list of token ids or use a range START_ID - END_ID. 
            </FormHelperText>
          </FormControl>
      ...
      <DrawerFooter>
        ...
        <TransactionButton
          ...
          isDisabled={!isDirty}
        >
          {lazyMintMutation && " "} Create Unlockable Content
        </TransactionButton>
      </DrawerFooter>
    </>
  );
